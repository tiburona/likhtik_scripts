function data = populate_post_phy_data_structure(animal_dir, animal_data, ToneOnCode, ToneOffCode)
    ...
    data.tone_onsets = ToneOn_ts;
    data.tone_offsets = ToneOff_ts;
    ...
    tone_onsets_expanded = zeros(1, length(data.tone_onsets) * tones_per_period);
    for j = 1:length(data.tone_onsets)
