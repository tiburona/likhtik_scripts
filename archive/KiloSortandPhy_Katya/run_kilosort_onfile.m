function run_kilosort_onfile(rootZ,chanMapFile)
...
% temp=load([pathToYourConfigFile,'/',chanMapFile);
load([pathToYourConfigFile,'\',chanMapFile],'chanMap','chanMap0ind','connected','kcoords','name','xcoords','ycoords');
n_channels=length(chanMap);
...
save([pathToYourConfigFile,'\',chanMapFile],'chanMap','chanMap0ind','connected','kcoords','name','xcoords','ycoords');
%
