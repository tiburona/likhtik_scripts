function main_kilosort3_ks(dataPath)

%% you need to change most of the paths in this block

addpath(genpath('C:\Users\Likhtik Lab\katie\software\')) % path to kilosort folder
...
pathToYourConfigFile = 'C:\Users\Likhtik Lab\katie\likhtik_scripts'; % take from Github folder and put it somewhere else (together with the master_file)
